...
Route::prefix('/')->middleware('isUser')->group(function (){
    ...
    Route::get('balance',[HomeController::class,"balance"])->name('balance');
    Route::post('balancepost',[HomeController::class,"balancepost"])->name('balancepost');
    Route::get('ınquiry',[HomeController::class,"ınquiry"])->name('ınquiry');
});
...
Route::get('civilian',[AdminController::class,"civilian"])->name('civilian');
